<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="{{route('account.showchangePaswordForm')}}"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-lock"></i> Change Password</a>
    </li>
    <li class="nav-item">
        <a href="{{route('account.logout')}}" onclick="return confirm('Are you sure you want to logout?')" class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-sign-out-alt"></i> Logout</a>
    </li>
</ul>
