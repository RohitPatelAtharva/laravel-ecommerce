   ...
   <div class="container-fluid my-2">
       <div class="row mb-2">
           ...
           <div class="col-sm-6 text-right">
               <a href="{{route('sections.create')}}" class="btn btn-primary">New Category</a>
           </div>
       </div>
   </div>
   <!-- /.container-fluid -->
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               ...
                               <a href="#" onclick="deletePage({{ $section->id }})" class="text-danger w-4 h-4 mr-1">
