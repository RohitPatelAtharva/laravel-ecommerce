        ...
        <div class="container pb-5 pt-3">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form action="{{ route('subscribe') }}" class="newsletter"  id="subscribeEmail" method="post">
                        @csrf
                        <div class="d-flex">
                            <input class="form-control" id="subscribeEmail" placeholder="Emai Address Here" name="email" type="email"
                                style="color: white;">
                            <button class="main-btn" type="submit">Subscribes</button>
                        </div>
                    </form>
                </div>
            </div>
