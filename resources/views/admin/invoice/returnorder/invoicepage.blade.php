                        ...
                        <div class="title-action">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <button type="button" class="dropdown-item" onclick="submitForm()">PDF
                                        Download</button>
                                </div>
                            </div>
            ...
            <div class="invoice-box">
                ...
                <div class="row invoice-details">
                    <div class="col-sm-6">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-bold-800"><a href="#"><strong
                                        class="invoice_a">{{ $client->name }}</strong></a></li>
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <p><span class="text-muted">Invoice Date:</span> {{ now()->format('d-m-Y') }}</p>
                        <p><span class="text-muted">Due Date:</span> {{ now()->format('d-m-Y') }}</p>
                        ...
                        <tbody>
                            @foreach ($returnItems as $item)
                                <tr>
                                    ...
                                    <td>{{ Illuminate\Support\Str::limit($item->item_name, 20) }}</td>
                                    <td>{{ $item->rate }}</td>
                                    <td>{{ $item->quantity }}</td>
                                    <td>18%</td>
                                    <td>{{ $item->discount }}</td>
                    ...
                    <div class="col-sm-7 text-center text-md-left">
                        <div>
                            ...
                            <img src="{{ asset('images/Blue_Simple_Lines_Circular_Monogram_Badge_Logo-removebg-preview.png') }}"
                                alt="stamp" class="img-responsive p-1 m-b-2" style="max-height: 200px;">
                        </div>
                    </div>
                    <div class="col-sm-5">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>Total Tax</td>
                                        <td class="text-xs-right"> Rs. {{ $orderReturn->total_tax }}</td>
                                    </tr>
                                    <tr>
                                        <td>Total Discount</td>
                                        <td class="text-xs-right"> Rs. {{ $orderReturn->total_discount }}</td>
                                    </tr>
                                    <tr>
                                        <td> Shipping</td>
                                    ...
                                    <tr>
                                        <td> Sub Total</td>
                                        <td class="text-xs-right">Rs. {{ $orderReturn->subtotal }}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-800">Total</td>
                                        <td class="text-bold-800 text-xs-right">Rs.
                                            {{ $orderReturn->grand_total }}</td>
                                    </tr>
                                    <tr>
                                        <td>Payment status</td>
                                        <td class="pink text-xs-right">
                                            (-) <span id="paymade"> </span>
                                        </td>
                                    </tr>
